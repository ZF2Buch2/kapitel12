...
Die Projektdateien für das Kapitel 12 vom Buch **Zend Framework 2 - Von den 
...
* Sie können die Projektdateien als ZIP von der Website http://www.awl.de/2994 
  unter Downloads oder von GitHub https://github.com/ZF2Buch/kapitel12 herunter
...
```
    ...
    $ git clone https://github.com/ZF2Buch/kapitel12.git
    $ cd kapitel12/
```
